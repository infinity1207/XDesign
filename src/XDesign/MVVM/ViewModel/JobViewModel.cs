...
namespace XDesign.MVVM.ViewModel
{
    public partial class JobViewModel : ViewModelBase
    {
        ...
        private RelayCommand<MainWindow> _printCommand;
        public RelayCommand<MainWindow> PrintCommand
        {
            get
            {
                if (_printCommand == null)
                {
                    _printCommand = new RelayCommand<MainWindow>((owner) =>
                    {
                        PrintWindow printWindow = new PrintWindow();
                        printWindow.Owner = owner;
